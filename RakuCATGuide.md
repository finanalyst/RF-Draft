...
<div id="VERSION&nbsp;&nbsp;&nbsp;&nbsp;v 0.2.0"></div><div id="VERSION"></div>

## VERSION&nbsp;&nbsp;&nbsp;&nbsp;v 0.2.0

<div id="Article 1. Preface"></div><div id="Preface"></div>
...
<div id="Article 2. &lt;span class="para" id="dbefef4">&lt;/span>Raku Community Affairs Team organisation"></div><div id="CAT_organisation"></div>
...
<div id="Article 3. Process"></div><div id="Process"></div>
...
<div id="Article 3.1. Investigating an Incident"></div><div id="Investigating_an_Incident"></div>
...
<div id="Article 4. Responding to an Incident"></div><div id="Responding_to_an_Incident"></div>
...
<div id="Article 4.1. Allowed Responses"></div><div id="Allowed_Responses"></div>
...
&nbsp;&nbsp;• Temporarily banning the violator from one or more Raku community spaces for upto 30 days.  
&nbsp;&nbsp;• Publicly reprimanding the violator.  
&nbsp;&nbsp;• Recommending to the Executive Board of the Raku Foundation to temporarily ban the violator from one or more Raku community spaces.  
&nbsp;&nbsp;• Recommending to the Executive Board of the Raku Foundation to permanently ban the violator from one or more Raku community spaces.  
&nbsp;&nbsp;• Recommending to the Executive Board of the Raku Foundation to eject the violator from the Raku community.  
&nbsp;&nbsp;• If the violator is a member of the Executive Board, recommending to the Supervisory Board to suspend the violator from the Executive Board.  
&nbsp;&nbsp;• If the violated is a member of the Supervisory Board, recommending to the Supervisory Board to dismiss the violator from the Supervisory Board.  
...
<div id="Article 4.2. Disallowed Responses"></div><div id="Disallowed_Responses"></div>
...
<div id="Article 4.3. Mediation"></div><div id="Mediation"></div>
...
<div id="Article 5. Continued violation"></div><div id="Continued_violation"></div>
...
<div id="Article 6. Reports after action"></div><div id="Reports_after_action"></div>
...
<div id="Article 7. Archiving"></div><div id="Archiving"></div>
...
<div id="Article 8. Summary"></div><div id="Summary"></div>
...
<div id="Article 9. Feedback and community response"></div><div id="Feedback_and_community_response"></div>
...
Rendered from ./RakuCATGuide.rakudoc/RakuCATGuide at 16:48 UTC on 2026-06-23

Source last modified at 16:47 UTC on 2026-06-23
